...
const {renderLogin, renderSignUp, renderAdminLogin, renderOtpPage, signup, verifyOtp, userLogin, adminlogin, resendOtp, renderForgotPasssword, verifyUser, renderForgotPasswordOtp, verifyForgotPassswordOtp, renderResetPassword, resetPassword, forgotPasswordResendOtp}= require('../Controller/authController')
